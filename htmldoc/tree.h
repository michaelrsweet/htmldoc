//
// "$Id: tree.h,v 1.7 2002/04/01 11:56:14 mike Exp $"
//
...
struct hdTree
{
  ...
  hdTree		*build_index(hdStyleSheet *css, int num_words, const char **words);
...
//
// End of "$Id: tree.h,v 1.7 2002/04/01 11:56:14 mike Exp $".
//
