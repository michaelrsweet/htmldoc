//
// "$Id: http-md5.cxx,v 1.1 2002/01/02 22:59:42 mike Exp $"
//
	...
	char       md5[33])	/* O - MD5 string */
{
  ...
  */
  ...
  state.init();
  state.append((md5_byte_t *)line, strlen(line));
  state.finish(sum);
  ...
  */
  ...
  return (hdHTTP::md5_string(sum, md5));
}
...
hdHTTP::md5_string(const md5_byte_t *sum,	/* I - MD5 sum data */
...
/*
 * End of "$Id: http-md5.cxx,v 1.1 2002/01/02 22:59:42 mike Exp $".
 */
