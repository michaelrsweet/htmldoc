--
-- "$Id: htmldoc.sql,v 1.6 2004/10/16 00:56:16 mike Exp $"
--
-- Database schema for the project web pages.
--
-- This SQL file has been tested with SQLite, PostgreSQL, and MySQL.
--
-- Revision History:
--
...
--   M. Sweet   06/16/2004   Added type field to article.
--   M. Sweet   09/18/2004   Change to Apache crypt password schema.
--   M. Sweet   09/25/2004   Added articlefile table.
--   M. Sweet   09/29/2004   Renamed "users" table to "user" for consistency.
--   M. Sweet   10/15/2004   Renamed "manager_email" in "str" table to
--                           "manager_user" for consistency, and made
--                           "hash" in "user" table 255 chars to support
--                           MD5 passwords.
--
...
CREATE TABLE article (
  ...
  type VARCHAR(255),			-- Article type ("NEWS", "FAQ", etc.)
...
--
-- Schema for table 'articlefile'
--
-- This table tracks the files that are attached to an article.
--

CREATE TABLE articlefile (
  id INTEGER PRIMARY KEY AUTO_INCREMENT,-- File ID
  article_id INTEGER,			-- Article number
  is_published INTEGER,			-- 0 = private, 1 = public
...
CREATE TABLE str (
  ...
  manager_user VARCHAR(255),		-- Manager of STR
  create_date INTEGER,			-- Time/date of creation
...
CREATE TABLE user (
  ...
  hash CHAR(255),			-- crypt(password)
  level INTEGER,			-- 0 = user, 50 = developer, 100 = admin
  create_date INTEGER,			-- Time/date of creation
...
--
-- End of "$Id: htmldoc.sql,v 1.6 2004/10/16 00:56:16 mike Exp $".
--
