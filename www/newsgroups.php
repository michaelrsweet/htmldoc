<?php
//
// "$Id: newsgroups.php,v 1.16 2006/06/22 13:44:34 mike Exp $"
//
// Forum page...
//
// Contents:
	   ...
	   $group = "")			// I - Current group, if any
{
  ...
  $links["All Forums"] = "newsgroups.php";
  if ($group != "")
...
//
// End of "$Id: newsgroups.php,v 1.16 2006/06/22 13:44:34 mike Exp $".
//
?>
