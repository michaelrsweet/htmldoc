...
# ADD LINK32 libeay32.lib ssleay32.lib comctl32.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:console /machine:I386 /nodefaultlib:"libcmt.lib" /out:"htmldoc.exe" /libpath:"../../openssl-0.9.6a/out32dll"
