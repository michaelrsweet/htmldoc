...
INSTALLING HTMLDOC UNDER MICROSOFT WINDOWS
    ...
    the "htmldoc-1.8.16-windows.exe" or "htmldoc-1.8.16-winfree.exe" files
...
INSTALLING HTMLDOC UNDER RED HAT LINUX
    ...
    Type the following command to install HTMLDOC under Red Hat Linux:
        ...
        rpm -i htmldoc-1.8.16-linux-2.0-intel.rpm ENTER

    or:

        rpm -i htmldoc-1.8.16-linux-2.2-intel.rpm ENTER

    or:

        rpm -i htmldoc-1.8.16-linux-2.4-intel.rpm ENTER
...
INSTALLING HTMLDOC UNDER UNIX
    ...
    Type the following commands to install HTMLDOC under UNIX:
        ...
        gunzip htmldoc-1.8.16-platform.tar.gz ENTER
	tar xf htmldoc-1.8.16-platform.tar ENTER
...
INSTALLING HTMLDOC UNDER MacOS X
    ...
    Type the following commands to install HTMLDOC under MacOS X:
        ...
        tar xzf htmldoc-1.8.16-darwin-1.4-powerpc.tar.gz ENTER
